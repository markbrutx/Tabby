...
use crate::workspace::domain::layout::split_tree;
use crate::workspace::domain::layout::{SplitDirection, SplitNode};
use crate::workspace::domain::pane::{create_tab_id, PaneKind, PaneSeed};
use crate::workspace::domain::snapshot::{
    PaneRuntimeStatus, PaneSnapshot, TabSnapshot, WorkspaceSnapshot,
};
...
mod tests {
    ...
    fn pane_seed(id: &str) -> PaneSeed {
        PaneSeed {
            ...
            pane_kind: crate::workspace::domain::pane::PaneKind::Terminal,
            url: None,
        }
    }
    ...
    fn swap_panes_swaps_layout_positions() {
        ...
        let pane_ids = crate::workspace::domain::layout::split_tree::collect_pane_ids(
