...
export type SettingsView = { defaultLayout: LayoutPresetDto; defaultTerminalProfileId: string; defaultWorkingDirectory: string; defaultCustomCommand: string; fontSize: number; theme: string; launchFullscreen: boolean; hasCompletedOnboarding: boolean; lastWorkingDirectory: string | null }
